...
var Counter = cc.Layer.extend({
    ...
    init: function (params) {
        ...
        if (params) {
            this._double = params.double;
        }
        this.addLabel();
    },

    addLabel: function () {
//        this._label = cc.LabelTTF.create(this._double ? "00" : "0", getFontNamePlatform(res.fontFoo), 32, cc.size(0, 0), cc.TEXT_ALIGNMENT_CENTER, cc.TEXT_ALIGNMENT_CENTER);
//        this._label.setColor(Globals.TEXT_COLOR);
        this._label = new cc.LabelBMFont("", res.fooFNT, 0, cc.TEXT_ALIGNMENT_CENTER);
