...
Globals.TEXT_COLOR = cc.color(250,229,80);
...
Globals.redirectExit = function () {
    if (Globals.EXITURL.indexOf("_EXIT_URL_") == -1) {
        Globals.redirectURL(Globals.EXITURL);
    }
};

Globals.redirectURL = function (url) {
    if (!cc.sys.isNative) {
        window.location.assign(url);
    } else {
        cc.log("redirect on native not implemented")
    }
};
